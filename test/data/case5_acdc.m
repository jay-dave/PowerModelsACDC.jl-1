...
mpc.branch = [
    ...
    2   4   0.06    0.18    0.04    100   100   100     0       0       0 -60 60;
    2   5   0.04    0.12    0.03    100   100   100     0       0       1 -60 60;
    3   4   0.01    0.03    0.02    100   100   100     0       0       0 -60 60;
...
mpc.convdc = [
    1       2   1       1       -60    -40    0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     1.1     1       1.103 0.887  2.885    2.885      0.0050    -58.6274   1.0079   0 100 -100 50 -50 1;
    2       3   2       1       0       0     0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     1.1     1       1.103 0.887  2.885    2.885      0.0070     21.9013   1.0000   0 100 -100 50 -50 1;
    3       5   1       1       35       5    0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     1.1     1       1.103 0.887  2.885    2.885      0.0050     36.1856   0.9978   0 100 -100 50 -50 2;
%		3       5   1       1       35       5    0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     1.1     0       1.103 0.887  2.885    2.885      0.0050     36.1856   0.9978   0 100 -100 50 -50 2;
];

%% branches
%column_names%   fbusdc  tbusdc  r      l        c   rateA   rateB   rateC   status fail_prob
mpc.branchdc = [
    1       2       0.052   0   0    100     100     100     1 0.1;
    2       3       0.052   0   0    100     100     100     1 0.1;
    1       3       0.073   0   0    100     100     100     1 0.1;
%		1       3       0.073   0   0    100     100     100     0 0.1;
 ];
