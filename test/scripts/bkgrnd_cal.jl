...
function display_keyindictionary(dict, key1, key2)
    ...
    display("################interval################")
    for (n, nw) in dict["solution"]["nw"]
    display("z1:n$n $(nw["reserves"]["2"]["z1"]) z2: $(nw["reserves"]["2"]["z2"]) z3: $(nw["reserves"]["2"]["z3"]) z4: $(nw["reserves"]["2"]["z4"])")
    end
    display("################gen################")
    for (n, nw) in dict["solution"]["nw"]
    ...
    display("################branch################")
    for (n, nw) in dict["solution"]["nw"]
    display("b1:n$n $(nw["branchdc_ne"]["1"]["pf"])  b2: $(nw["branchdc_ne"]["2"]["pf"]) b3: $(nw["branchdc_ne"]["3"]["pf"]) b4: $(nw["branchdc_ne"]["4"]["pf"])  b5: $(nw["branchdc_ne"]["5"]["pf"])  b6: $(nw["branchdc_ne"]["6"]["pf"]) b7: $(nw["branchdc_ne"]["7"]["pf"]) b8: $(nw["branchdc_ne"]["8"]["pf"])")
...
function Protectionsystemcost_6bus(data, PS, no_nw)
    ...
    for (n,nw) in data["nw"]
        ...
        if PS == "FS_HDCCB"
                  ...
                  # nw["branchdc_ne"]["1"]["cost"] = 448.91/no_nw;
                  nw["branchdc_ne"]["1"]["cost"] = 1288.91*0.5/no_nw; nw["branchdc_ne"]["2"]["cost"] = 658.91*0.5/no_nw; nw["branchdc_ne"]["3"]["cost"] = 1288.91*0.5/no_nw
                  nw["branchdc_ne"]["4"]["cost"] = 448.91*0.5/no_nw; nw["branchdc_ne"]["5"]["cost"] = 1491.7*0.5/no_nw;
                  # nw["branchdc_ne"]["7"]["cost"] = 232.36/no_nw;
                  nw["branchdc_ne"]["6"]["cost"] = 1288.91*0.5/no_nw; nw["branchdc_ne"]["7"]["cost"] = 1708.91*0.5/no_nw;
                  nw["branchdc_ne"]["8"]["cost"] = 868.91*0.5/no_nw;  nw["branchdc_ne"]["9"]["cost"] = 868.91*0.5/no_nw;
        elseif PS == "FS_MDCCB"
                  ...
                  # nw["branchdc_ne"]["1"]["cost"] = 440.40/no_nw;
                  nw["branchdc_ne"]["1"]["cost"] = 1280.41*0.5/no_nw; nw["branchdc_ne"]["2"]["cost"] = 650.40*0.5/no_nw; nw["branchdc_ne"]["3"]["cost"] = 1280.41*0.5/no_nw
                  nw["branchdc_ne"]["4"]["cost"] = 440.40*0.5/no_nw; nw["branchdc_ne"]["5"]["cost"] = 1482.24*0.5/no_nw;
                  # nw["branchdc_ne"]["7"]["cost"] = 227.84/no_nw;
                  nw["branchdc_ne"]["6"]["cost"] = 1280.41*0.5/no_nw; nw["branchdc_ne"]["7"]["cost"] = 1700.41*0.5/no_nw;
                  nw["branchdc_ne"]["8"]["cost"] = 860.407*0.5/no_nw
                  # nw["branchdc_ne"]["9"]["cost"] = 227.84/no_nw; nw["branchdc_ne"]["10"]["cost"] = 745.66/no_nw;

        elseif PS == "NS_CB"
                  nw["convdc_ne"]["1"]["cost"] = 268.7*0.5/no_nw; nw["convdc_ne"]["2"]["cost"] = 268.7/no_nw; nw["convdc_ne"]["6"]["cost"] = 268.7/no_nw;
                  nw["convdc_ne"]["3"]["cost"] = 352.21*0.5/no_nw; nw["convdc_ne"]["4"]["cost"] = 352.21/no_nw; nw["convdc_ne"]["5"]["cost"] = 352.21/no_nw;
                  ...
                  # nw["branchdc_ne"]["7"]["cost"] = 227.84/no_nw;
                  nw["branchdc_ne"]["6"]["cost"] = 1280.41*0.5/no_nw; nw["branchdc_ne"]["7"]["cost"] = 1700.41*0.5/no_nw;
                  nw["branchdc_ne"]["8"]["cost"] = 860.407*0.5/no_nw; nw["branchdc_ne"]["9"]["cost"] = 860.407*0.5/no_nw
                  # nw["branchdc_ne"]["9"]["cost"] = 227.84/no_nw; nw["branchdc_ne"]["10"]["cost"] = 745.66/no_nw;
      ...
      elseif PS == "Permanentloss"
                  nw["convdc_ne"]["1"]["cost"] = 263.28/no_nw; nw["convdc_ne"]["2"]["cost"] = 263.28/no_nw; nw["convdc_ne"]["6"]["cost"] = 263.28/no_nw;
                  nw["convdc_ne"]["3"]["cost"] = 342.26/no_nw; nw["convdc_ne"]["4"]["cost"] = 342.26/no_nw; nw["convdc_ne"]["5"]["cost"] = 342.26/no_nw;

                  nw["branchdc_ne"]["1"]["cost"] = 1260/no_nw; nw["branchdc_ne"]["2"]["cost"] = 630/no_nw; nw["branchdc_ne"]["3"]["cost"] = 1260/no_nw
                  nw["branchdc_ne"]["4"]["cost"] = 420/no_nw; nw["branchdc_ne"]["5"]["cost"] = 1470/no_nw;
                  nw["branchdc_ne"]["6"]["cost"] = 1260/no_nw; nw["branchdc_ne"]["7"]["cost"] = 1680/no_nw;
                  nw["branchdc_ne"]["8"]["cost"] = 840/no_nw ; nw["branchdc_ne"]["9"]["cost"] = 840/no_nw
        end
    end
...
function curtailment(data_cont, base_list, resultDC1, curtailed_gen)
    ...
    formax1 =[]
     ...
     return curt, maximum(formax), maximum(formax1), average(formax), average(formax1)
end
