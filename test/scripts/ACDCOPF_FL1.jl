...
curtailed_gen = [1,2] #geneartor numbers
max_curt = 0
...
# for proti = 1:5
    ...
    include("C:/Users/djaykuma/Documents/Julia1.3/dev/PowerModelsACDC/test/scripts/bkgrnd_cal.jl")
    ...
    data_cont, Cont_list, base_list = mp_contignecy(deepcopy(data_ps), Total_sample*total_yr, 1)
        ...
        "Permanentloss" => false, "Cont_list" => Cont_list,"base_list" => base_list,"Total_sample" =>Total_sample, "curtailed_gen" => curtailed_gen, "max_curt" => max_curt)
        ...
        "Permanentloss" => true, "Cont_list" => Cont_list,"base_list" => base_list,"Total_sample" =>Total_sample, "curtailed_gen" => curtailed_gen, "max_curt" => max_curt)
        end
...
# fuel_cost = 8:1:12
# column = ["A" "B" "C" "D" "E" "F" "G" "H"]
# filepath = string("C:\\Users\\djaykuma\\OneDrive - Energyville\\Freq_TNEP_paper\\MATLAB\\plots\\OPF\\fuel_cost\\",Prot_system,".xlsx", )
# XLSX.openxlsx(filepath, mode = "w") do xf
...
#         sheet = xf[1]
#         cell_no = string(column[i], i)
#         sheet["$(string(column[i],1))"] = data_cont["nw"]["1"]["gen"]["3"]["cost"][3]
#         sheet["$(string(column[i],2))"] = resultDC1["solution"]["nw"]["1"]["Reserves"]
#         sheet["$(string(column[i],3))"] = resultDC1["solution"]["nw"]["1"]["Gen_cost"]
#         sheet["$(string(column[i],4))"] = resultDC1["solution"]["nw"]["1"]["Cont"]
#     end
# end
######################end fuel cost############################
...
# FFR_cost = 64:8:96
# column = ["A" "B" "C" "D" "E" "F" "G" "H"]
# filepath = string("C:\\Users\\djaykuma\\OneDrive - Energyville\\Freq_TNEP_paper\\MATLAB\\plots\\OPF\\FFR_cost\\",Prot_system,".xlsx")
# XLSX.openxlsx(filepath, mode="w") do xf
...
# column = ["A" "B" "C" "D" "E" "F" "G" "H"]
# filepath = string("C:\\Users\\djaykuma\\OneDrive - Energyville\\Freq_TNEP_paper\\MATLAB\\plots\\OPF\\FCR_cost\\",Prot_system,".xlsx")
# XLSX.openxlsx(filepath, mode="w") do xf
...
#          sheet = xf[1]
#          cell_no = string(column[i],i)
#          sheet["$(string(column[i],1))"] = data_cont["nw"]["1"]["reserves"]["2"]["Cg"]
#          sheet["$(string(column[i],2))"] = resultDC1["solution"]["nw"]["1"]["Reserves"]
#          sheet["$(string(column[i],3))"] = resultDC1["solution"]["nw"]["1"]["Gen_cost"]
#          sheet["$(string(column[i],4))"] = resultDC1["solution"]["nw"]["1"]["Cont"]
#         end
...
# column = ["A" "B" "C" "D" "E" "F" "G" "H"]
# filepath = string("C:\\Users\\djaykuma\\OneDrive - Energyville\\Freq_TNEP_paper\\MATLAB\\plots\\OPF\\FFR_time\\",Prot_system,".xlsx")
# XLSX.openxlsx(filepath, mode="w") do xf
...
#          sheet = xf[1]
#          cell_no = string(column[i],i)
#          sheet["$(string(column[i],1))"] = data_cont["nw"]["1"]["reserves"]["2"]["Tf"]
#          sheet["$(string(column[i],2))"] = resultDC1["solution"]["nw"]["1"]["Reserves"]
#          sheet["$(string(column[i],3))"] = resultDC1["solution"]["nw"]["1"]["Gen_cost"]
#          sheet["$(string(column[i],4))"] = resultDC1["solution"]["nw"]["1"]["Cont"]
#         end
...
# FCR_time = [5  10]
# column = ["A" "B" "C" "D" "E" "F" "G" "H"]
# filepath = string("C:\\Users\\djaykuma\\OneDrive - Energyville\\Freq_TNEP_paper\\MATLAB\\plots\\OPF\\FCR_time\\",Prot_system,".xlsx")
# XLSX.openxlsx(filepath, mode="w") do xf
...
#          sheet = xf[1]
#          cell_no = string(column[i],i)
#          sheet["$(string(column[i],1))"] = data_cont["nw"]["1"]["reserves"]["2"]["Tg"]
#          sheet["$(string(column[i],2))"] = resultDC1["solution"]["nw"]["1"]["Reserves"]
#          sheet["$(string(column[i],3))"] = resultDC1["solution"]["nw"]["1"]["Gen_cost"]
#          sheet["$(string(column[i],4))"] = resultDC1["solution"]["nw"]["1"]["Cont"]
#         end
...
curtl = [0 0.1 0.2 0.3]
column = ["A" "B" "C" "D" "E" "F" "G" "H"]
filepath = string("C:\\Users\\djaykuma\\OneDrive - Energyville\\Freq_TNEP_paper\\MATLAB\\plots\\OPF\\Curtailment\\",Prot_system,".xlsx")
XLSX.openxlsx(filepath, mode="w") do xf
for i = 1:length(curtl)
 ...
 sheet = xf[1]
            ...
            sheet["$(string(column[i],6))"] = resultDC1["objective"]
            sheet["$(string(column[i],7))"] = maxFFR
            sheet["$(string(column[i],7))"] = resultDC1["objective_lb"]
        end
end
